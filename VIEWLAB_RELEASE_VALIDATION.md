...
| WPF and broker | Pass | 4.1.209 Release publish completed with 0 warnings/errors. |
...
| Pistol Whip regression | **Pending user** | Follow `TOPMOST_VALIDATION.md`: force-direct baseline, then automatic Topmost static menu/gameplay and clean exit. |
...
| Visor/edge masks/calibration | **Pending user** | Visor parity in automatic Topmost, intended edge boundaries, literal-pixel grid and shared-tangent radial geometry. |
...
Do not publish 4.1.209 yet. Install it, run the ordered headset checks above, and add one compact row
