...
XrResult XRAPI_CALL xrCreateApiLayerInstance(const XrInstanceCreateInfo *pCreateInfo, const XrApiLayerCreateInfo *pApiLayerInfo, XrInstance *pInstance)
{
	...
	get_instance_proc(instance.handle, "xrWaitSwapchainImage", reinterpret_cast<PFN_xrVoidFunction *>(&instance.dispatch_table.WaitSwapchainImage));
	get_instance_proc(instance.handle, "xrCreateReferenceSpace", reinterpret_cast<PFN_xrVoidFunction *>(&instance.dispatch_table.CreateReferenceSpace));
	get_instance_proc(instance.handle, "xrDestroySpace", reinterpret_cast<PFN_xrVoidFunction *>(&instance.dispatch_table.DestroySpace));
