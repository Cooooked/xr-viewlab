...
Assert-Contains 'dllmain.cpp' 'hudTraceVisibilityMode == 2' 'native trace implements alarm-only visibility'
Assert-Contains 'dllmain.cpp' 'g_hudTraceFadeStartTick' 'alarm-only trace fades once after recovery hold'
