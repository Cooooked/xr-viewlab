...
Need $previewModel 'ReferenceWidth \* available\.Width \* item\.Scale' 'preview width does not apply scale exactly once'
Need $previewModel 'ReferenceHeight \* available\.Height \* item\.Scale' 'preview height does not apply scale exactly once'
Need $previewModel 'return new Size\(width \* fit, height \* fit\)' 'preview bounds fitting does not preserve aspect ratio'
Need $preview 'QUEST 3 FULL BINOCULAR  H 1\.00  V 1\.00' 'full binocular crop reference is absent'
...
Need $preview 'visibleOval' 'natural binocular visibility oval is absent'
