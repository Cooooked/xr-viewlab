...
//---------------------------------------------------------------------------------------------------------------------
	...
	void VisionFilter::render()
	{
		...
		// LiveVisionKit 1.2.2's release ABI predates OBS's public colour-space
		// query. ViewLab Media Capture supplies SDR sRGB, so retain the upstream
		// render path without binding this focused port to a newer OBS header ABI.
